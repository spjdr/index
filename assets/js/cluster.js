...
var cluster = {   
	...
	Node : function(x,y,parent) {
		...
		t.el.setAttribute('x', 0)
		t.el.setAttribute('x', x)
	    t.el.setAttribute('y', y)
	    t.el.setAttribute('height', parent.radius)
        	    t.el.setAttribute('width', parent.radius)
	...
	speed: 1000,
	timeout: -700,
	colors : ["#00CC00","#00AA00","#00EE00","#00AA00"] 
